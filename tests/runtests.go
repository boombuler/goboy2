...
var mooneyeTests = [][]string{
	...
	[]string{"oam_dma", "sources-dmgABCmgbS"},
	...
	[]string{"boot_hwio-dmgABCmgb"},
	[]string{"boot_hwio-S"},
	[]string{"boot_regs-dmg0"},
	[]string{"boot_regs-dmgABC"},
	[]string{"boot_regs-mgb"},
	[]string{"boot_regs-sgb"},
	[]string{"boot_regs-sgb2"},
