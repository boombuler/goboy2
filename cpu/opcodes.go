...
func createOpCodeTable() opCodeTable {
	...
	return opCodeTable{
		/* 0x00: */ named{"NOP", nop()},
		/* 0x01: */ named{"LD BC, nn", ld(bc.Write(), paramW())},
		/* 0x02: */ named{"LD (BC), A", ld(bc.Deref().Write(), a.Read())},
		/* 0x03: */ named{"INC BC", incR16(bc)},
		/* 0x04: */ named{"INC B", incR8(b)},
		/* 0x05: */ named{"DEC B", decR8(b)},
		/* 0x06: */ named{"LD B, n", ld(b.Write(), paramB())},
		/* 0x07: */ named{"RLCA", rlca()},
		/* 0x08: */ named{"LD (nn), SP", pipe(sp.Read(), paramW(), writeWord())},
		/* 0x09: */ named{"ADD HL, BC", addR16(hl, bc)},
		/* 0x0A: */ named{"LD A, (BC)", ld(a.Write(), bc.Deref().Read())},
		/* 0x0B: */ named{"DEC BC", decR16(bc)},
		/* 0x0C: */ named{"INC C", incR8(c)},
		/* 0x0D: */ named{"DEC C", decR8(c)},
		/* 0x0E: */ named{"LD C, n", ld(c.Write(), paramB())},
		/* 0x0F: */ named{"RRC A", rrca()},
		/* 0x10: */ named{"STOP", stop()},
		/* 0x11: */ named{"LD DE, nn", ld(de.Write(), paramW())},
		/* 0x12: */ named{"LD (DE), A", ld(de.Deref().Write(), a.Read())},
		/* 0x13: */ named{"INC DE", incR16(de)},
		/* 0x14: */ named{"INC D", incR8(d)},
		/* 0x15: */ named{"DEC D", decR8(d)},
		/* 0x16: */ named{"LD D, n", ld(d.Write(), paramB())},
		/* 0x17: */ named{"RLA", rla()},
		/* 0x18: */ named{"JR n", jr(flag(0), false)},
		/* 0x19: */ named{"ADD HL, DE", addR16(hl, de)},
		/* 0x1A: */ named{"LD A, (DE)", ld(a.Write(), de.Deref().Read())},
		/* 0x1B: */ named{"DEC DE", decR16(de)},
		/* 0x1C: */ named{"INC E", incR8(e)},
		/* 0x1D: */ named{"DEC E", decR8(e)},
		/* 0x1E: */ named{"LD E, n", ld(e.Write(), paramB())},
		/* 0x1F: */ named{"RRA", rra()},
		/* 0x20: */ named{"JR NZ, n", jr(zero, true)},
		/* 0x21: */ named{"LD HL, nn", ld(hl.Write(), paramW())},
		/* 0x22: */ named{"LDI (HL), A", pipe(a.Read(), hl.Deref().Write(), incHLFast())},
		/* 0x23: */ named{"INC HL", incR16(hl)},
		/* 0x24: */ named{"INC H", incR8(h)},
		/* 0x25: */ named{"DEC H", decR8(h)},
		/* 0x26: */ named{"LD H,n", ld(h.Write(), paramB())},
		/* 0x27: */ named{"DAA", daa()},
		/* 0x28: */ named{"JR Z, n", jr(zero, false)},
		/* 0x29: */ named{"ADD HL, HL", addR16(hl, hl)},
		/* 0x2A: */ named{"LDI A, (HL)", pipe(hl.Deref().Read(), a.Write(), incHLFast())},
		/* 0x2B: */ named{"DEC HL", decR16(hl)},
		/* 0x2C: */ named{"INC L", incR8(l)},
		/* 0x2D: */ named{"DEC L", decR8(l)},
		/* 0x2E: */ named{"LD L, n", ld(l.Write(), paramB())},
		/* 0x2F: */ named{"CPL", cpl()},
		/* 0x30: */ named{"JR NC, n", jr(carry, true)},
		/* 0x31: */ named{"LD SP, nn", ld(sp.Write(), paramW())},
		/* 0x32: */ named{"LDD (HL), A", pipe(a.Read(), hl.Deref().Write(), decHLFast())},
		/* 0x33: */ named{"INC SP", incR16(sp)},
		/* 0x34: */ named{"INC (HL)", incR8(hl.Deref())},
		/* 0x35: */ named{"DEC (HL)", decR8(hl.Deref())},
		/* 0x36: */ named{"LD (HL), n", ld(hl.Deref().Write(), paramB())},
		/* 0x37: */ named{"SCF", scf()},
		/* 0x38: */ named{"JR C, n", jr(carry, false)},
		/* 0x39: */ named{"ADD HL, SP", addR16(hl, sp)},
		/* 0x3A: */ named{"LDD A, (HL)", pipe(hl.Deref().Read(), a.Write(), decHLFast())},
		/* 0x3B: */ named{"DEC SP", decR16(sp)},
		/* 0x3C: */ named{"INC A", incR8(a)},
		/* 0x3D: */ named{"DEC A", decR8(a)},
		/* 0x3E: */ named{"LD A, n", ld(a.Write(), paramB())},
		/* 0x3F: */ named{"CCFx", ccf()},
		/* 0x40: */ named{"LD B, B", ld(b.Write(), b.Read())},
		...
		/* 0xF9: */ named{"LD SP, HL", pipe(hl.Read(), sp.Write(), delay{})},
